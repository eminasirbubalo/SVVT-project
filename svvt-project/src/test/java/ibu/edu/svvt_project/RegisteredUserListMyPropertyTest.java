...
public class RegisteredUserListMyPropertyTest {
    ...
    void Task() throws InterruptedException{
        ...
        webDriver.findElement(By.xpath("/html/body/div[2]/div[1]/div/div[1]/div[1]/div[4]/header/nav/div/div[1]/a")).click();
        Thread.sleep(3000);
        String url = webDriver.getCurrentUrl();

        assertEquals("https://www.hotels.com/?locale=en_IE&pos=HCOM_EMEA&siteid=300000025", url);
    }
}
